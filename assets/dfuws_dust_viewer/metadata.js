window.DFUWS_METADATA = {
  ...
  "tiles": {
    ...
    "templates": {
      ...
      "planck_ebv": "tiles/planck_ebv/{z}/{x}/{y}.webp",
      "planck_temperature": "tiles/planck_temperature/{z}/{x}/{y}.webp",
      "planck_tau353": "tiles/planck_tau353/{z}/{x}/{y}.webp"
    }
  },
  "layers": {
    "dragonfly_g": {
    ...
    "planck_ebv": {
      "source_file": "planck_ebv.fits.fz",
      "label": "Planck E(B-V)",
      "unit": "mag",
      "display_cuts": {
        "mode": "fixed",
      ...
      "preview": "preview_planck_ebv.webp",
      "previews": {
        "viridis": "preview_planck_ebv_viridis.webp",
        "inferno": "preview_planck_ebv_inferno.webp",
    ...
    "planck_temperature": {
      "source_file": "planck_temperature.fits.fz",
      "label": "Planck T",
      "unit": "K",
      "display_cuts": {
        "mode": "fixed",
      ...
      "preview": "preview_planck_temperature.webp",
      "previews": {
        "viridis": "preview_planck_temperature_viridis.webp",
        "inferno": "preview_planck_temperature_inferno.webp",
    ...
    "planck_tau353": {
      "source_file": "planck_tau353.fits.fz",
      "label": "Planck \u03c4\u2083\u2085\u2083",
      "unit": "",
      "display_cuts": {
        "mode": "fixed",
      ...
      "preview": "preview_planck_tau353.webp",
      "previews": {
        "viridis": "preview_planck_tau353_viridis.webp",
        "inferno": "preview_planck_tau353_inferno.webp",
  ...
  "alignment": {
    ...
    "planck_reprojected_layers": {
      "planck": false,
      "planck_ebv": false,
      "planck_temperature": false,
      "planck_tau353": false
    },
    "tile_origin": "lower",
